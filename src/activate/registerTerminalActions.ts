...
const TERMINAL_COMMAND_IDS = {
	ADD_TO_CONTEXT: "mage-code.terminalAddToContext",
	FIX: "mage-code.terminalFixCommand",
	FIX_IN_CURRENT_TASK: "mage-code.terminalFixCommandInCurrentTask",
	EXPLAIN: "mage-code.terminalExplainCommand",
	EXPLAIN_IN_CURRENT_TASK: "mage-code.terminalExplainCommandInCurrentTask",
} as const
