...
import schemas from "../src/schemas/index.js" // Add index.js extension
...
async function main() {
	...
	await fs.copyFile('out/interface.d.ts', 'src/exports/mage-code.d.ts')

	await $`npx prettier --write src/exports/types.ts src/exports/mage-code.d.ts`
}
