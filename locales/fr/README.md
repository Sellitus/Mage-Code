...
1. [Installer Roo Code](https://docs.magecode.com/getting-started/installing)
...
Roo Code s'adapte à vos besoins avec des [modes](https://docs.magecode.com/basic-usage/using-modes) spécialisés :
...
Roo Code est livré avec des [outils](https://docs.magecode.com/basic-usage/how-tools-work) puissants qui peuvent :
