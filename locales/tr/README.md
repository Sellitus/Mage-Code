...
1. [Roo Code'u Yükleyin](https://docs.magecode.com/getting-started/installing)
...
Roo Code, özelleştirilmiş [modlar](https://docs.magecode.com/basic-usage/using-modes) ile ihtiyaçlarınıza uyum sağlar:
...
Roo Code, şunları yapabilen güçlü [araçlar](https://docs.magecode.com/basic-usage/how-tools-work) ile gelir:
