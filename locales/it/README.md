...
<br>
<div align="center">
  <h2>Unisciti alla Community di Mage Code</h2>
...
<div align="center">
<h1>Mage Code (precedentemente Roo Cline)</h1>
...
**Mage Code** è un **agente di codifica autonomo** basato sull'IA che vive nel tuo editor. Può:
...
Che tu stia cercando un partner di codifica flessibile, un architetto di sistema o ruoli specializzati come un ingegnere QA o un product manager, Mage Code può aiutarti a costruire software in modo più efficiente.

Consulta il [CHANGELOG](../CHANGELOG.md) per aggiornamenti dettagliati e correzioni.

---

## 🎉 Mage Code 3.11 Rilasciato

Mage Code 3.11 porta significativi miglioramenti di prestazioni e nuove funzionalità!
...
1. [Installa Mage Code](https://docs.magecode.com/getting-started/installing)
...
Mage Code si adatta alle tue esigenze con [modalità](https://docs.magecode.com/basic-usage/using-modes) specializzate:
...
Mage Code viene fornito con potenti [strumenti](https://docs.magecode.com/basic-usage/how-tools-work) che possono:
...
MCP estende le capacità di Mage Code permettendoti di aggiungere strumenti personalizzati illimitati. Integra con API esterne, connettiti a database o crea strumenti di sviluppo specializzati - MCP fornisce il framework per espandere la funzionalità di Mage Code per soddisfare le tue esigenze specifiche.

### Personalizzazione

Fai funzionare Mage Code a modo tuo con:
...
Grazie a tutti i nostri contributori che hanno aiutato a migliorare Mage Code!
...
**Goditi Mage Code!** Che tu lo tenga al guinzaglio corto o lo lasci vagare autonomamente, non vediamo l'ora di vedere cosa costruirai. Se hai domande o idee per funzionalità, passa dalla nostra [community di Reddit](https://www.reddit.com/r/MageCode/) o [Discord](https://discord.gg/magecode). Buona programmazione!
